...
const SuggestionPage = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <input type="submit" value="Vorschlag abschicken" style={{ backgroundColor: 'transparent', color: 'white', margin: '0.5vh', padding: '1vh', borderRadius: '10%', WebkitBoxShadow: '3px 4px 5px 2px rgba(0, 0, 0, 0.24)', boxShadow: '3px 4px 5px 2px rgba(0, 0, 0, 0.24)' }} />
      </div>
      <AnimatePresence>
        {isEmailSent && (
          <motion.p
          ...
          >
            Vorschlag erfolgreich übermittelt! Danke!
          </motion.p>
        )}
      </AnimatePresence>
    </form>
